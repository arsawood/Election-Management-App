...
function Booth128Multi({navigation}){
    return(
        ...
        <View style= {{flex:0.5, alignItems:'center',paddingTop:30}}>
            ...
            onPress = {() => navigation.navigate('Search 128')}>
        ...
        justifyContent:'space-around',paddingTop:10}}>
            ...
            borderRadius:20}}
            onPress = {() => navigation.navigate('128 Male')}>
            ...
            <TouchableOpacity style={{backgroundColor:'#38B6FF',height:60,width:170,
            borderRadius:20,}}
            onPress = {() => navigation.navigate('128 Female')}>
                <Text style = {{fontSize:25, textAlign:'center',color:'#FFF',paddingTop:10}}>
                    Female Voters
                </Text>
            </TouchableOpacity>
        ...
        justifyContent:'space-around',marginBottom:370,paddingTop:10}}>
            <TouchableOpacity style={{backgroundColor:'#38B6FF',height:60,width:170,
            borderRadius:20}}
            onPress = {() => navigation.navigate('128Muslims')}>
                <Text style = {{fontSize:25,textAlign:'center',color:'#FFF',paddingTop:10}}>
                    Muslim Voters
                </Text>
            </TouchableOpacity>
            <TouchableOpacity style={{backgroundColor:'#38B6FF',height:60,width:170,
            borderRadius:20,}}
            onPress = {() => navigation.navigate('128NonMuslim')}>
